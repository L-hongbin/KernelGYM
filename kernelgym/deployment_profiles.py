...
class RewardProfile:
    ...
    def env(self) -> dict[str, str]:
        return {
            ...
            "COMPUTE_SANITIZER_TOTAL_TIMEOUT_S": "60",
            "COMPUTE_SANITIZER_MEMCHECK_TIMEOUT_S": "20",
            "COMPUTE_SANITIZER_SYNCCHECK_TIMEOUT_S": "15",
            "COMPUTE_SANITIZER_RACECHECK_TIMEOUT_S": "30",
            "COMPUTE_SANITIZER_INITCHECK_TIMEOUT_S": "20",
            "COMPUTE_SANITIZER_MAX_KERNELS": "8",
            "COMPUTE_SANITIZER_MAX_ISSUES": "4",
            "COMPUTE_SANITIZER_PRINT_LIMIT": "1000",
