...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `cuda_agent` | 74 | 48 | 22 | 0 | 0 | 48 | 26 | 0 | 26 | 0.645 |
| `pybind11` | 74 | 42 | 26 | 1 | 0 | 42 | 30 | 0 | 30 | 0.855 |
...
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 74 | 33.81s | 32.79s | 52.49s | 76.43s |
| `pybind11` | 74 | 34.81s | 37.87s | 67.87s | 130.87s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 39.17s | 39.97s | 50.85s | 60.18s |
| `pybind11` | 42 | 43.92s | 44.36s | 57.96s | 76.52s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 58 | 30.16s | 26.41s | 38.03s | 40.96s |
| `pybind11` | 50 | 29.97s | 26.77s | 38.05s | 41.76s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 0.00s | 0.00s | 0.00s | 0.00s |
| `pybind11` | 42 | 0.00s | 0.00s | 0.00s | 0.00s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 7.67s | 7.70s | 17.90s | 23.96s |
| `pybind11` | 42 | 13.12s | 12.12s | 24.34s | 37.50s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 0.26s | 0.34s | 0.64s | 0.73s |
| `pybind11` | 42 | 0.32s | 0.36s | 0.57s | 0.69s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 26 | 8.71s | 7.16s | 14.30s | 18.88s |
| `pybind11` | 30 | 10.51s | 9.19s | 15.16s | 25.94s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 58 | 36.84s | 33.99s | 50.90s | 60.19s |
| `pybind11` | 51 | 39.09s | 37.69s | 58.08s | 75.14s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 40.58s | 42.73s | 54.80s | 76.68s |
| `pybind11` | 42 | 50.59s | 51.59s | 75.37s | 100.99s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 31.57s | 31.91s | 39.09s | 41.00s |
| `pybind11` | 42 | 31.92s | 31.86s | 38.13s | 41.90s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 39.60s | 40.64s | 51.78s | 60.25s |
| `pybind11` | 42 | 45.11s | 45.06s | 59.64s | 76.63s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 0.01s | 0.02s | 0.04s | 0.05s |
| `pybind11` | 42 | 0.01s | 0.02s | 0.04s | 0.05s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 30.83s | 31.26s | 38.33s | 40.22s |
| `pybind11` | 42 | 31.53s | 31.30s | 37.42s | 40.83s |
| `tvm_ffi` | 0 | — | — | — | — |
