...
| `pybind11` | 74 | 42 | 26 | 1 | 0 | 42 | 30 | 0 | 30 | 0.856 |
...
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 74 | 35.56s | 33.79s | 59.15s | 76.98s |
| `pybind11` | 74 | 37.57s | 37.56s | 61.38s | 108.93s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 39.59s | 41.15s | 58.69s | 68.53s |
| `pybind11` | 42 | 42.90s | 45.47s | 63.70s | 70.63s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 58 | 29.77s | 27.39s | 41.39s | 45.22s |
| `pybind11` | 50 | 30.85s | 27.74s | 40.84s | 45.60s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 5.16s | 7.68s | 20.70s | 25.15s |
| `pybind11` | 42 | 12.80s | 12.07s | 23.44s | 31.74s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 0.26s | 0.34s | 0.62s | 0.79s |
| `pybind11` | 42 | 0.30s | 0.36s | 0.58s | 0.69s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 58 | 38.68s | 36.38s | 60.59s | 77.58s |
| `pybind11` | 51 | 45.50s | 40.92s | 64.27s | 75.99s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 41.32s | 43.98s | 62.17s | 78.28s |
| `pybind11` | 42 | 48.83s | 48.41s | 65.04s | 77.31s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 33.21s | 33.10s | 41.73s | 45.40s |
| `pybind11` | 42 | 33.68s | 33.02s | 41.63s | 46.09s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 40.89s | 43.70s | 61.90s | 78.09s |
| `pybind11` | 42 | 48.34s | 48.08s | 64.53s | 77.16s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 0.01s | 0.02s | 0.02s | 0.05s |
| `pybind11` | 42 | 0.01s | 0.01s | 0.02s | 0.04s |
...
| Binding | n | p50 | mean | p90 | p99 |
|---|---:|---:|---:|---:|---:|
| `cuda_agent` | 48 | 32.71s | 32.43s | 40.92s | 44.59s |
| `pybind11` | 42 | 32.97s | 32.43s | 40.92s | 45.26s |
| `tvm_ffi` | 0 | — | — | — | — |
